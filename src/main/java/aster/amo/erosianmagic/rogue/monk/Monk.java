...
import aster.amo.erosianmagic.net.classsync.MonkSyncPacket;
import net.minecraft.nbt.CompoundTag;
import net.minecraft.world.entity.player.Player;
import net.minecraftforge.common.util.INBTSerializable;

public class Monk implements IMonk, INBTSerializable<CompoundTag> {
    ...
    public void sync(Player player) {
        if(!player.level().isClientSide) {
            Networking.sendToTracking(player.level(), player.blockPosition(), new MonkSyncPacket(serializeNBT(), player.getUUID()));
        }
    }
